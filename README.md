...
The primary objective is to develop two Natural Language Processing (NLP) algorithms capable of predicting the sentiment of a given review. The process will involve processing unstructured text to create meaningful numerical word representations.
